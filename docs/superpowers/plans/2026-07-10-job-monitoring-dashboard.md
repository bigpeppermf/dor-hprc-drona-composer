...
<div class="dm-grid">
  <div class="dm-tile">
    ...
    <div class="dm-bar"><div class="dm-bar-fill dm-bar--mem" style="width:60%"></div></div>
  ...
  <div class="dm-tile">
    ...
    <span class="dm-tile-sub">ave / min</span>
    <div class="dm-bar"><div class="dm-bar-fill dm-bar--cpu" style="width:60%"></div></div>
  ...
  <div class="dm-tile">
    ...
    <div class="dm-bar"><div class="dm-bar-fill dm-bar--io" style="width:40%"></div></div>
  ...
  <div class="dm-tile">
    ...
    <span class="dm-tile-sub">max / ave</span>
    <div class="dm-bar"><div class="dm-bar-fill dm-bar--accent" style="width:30%"></div></div>
